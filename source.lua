...
do
    function Utility:Log(Type, Message)
        ...
        if Type == 'error' then
            error('[ Central ] Error: ' .. Message)
        elseif Type == 'log' then
            print('[ Central ] ' .. Message)
        elseif Type == 'warn' then
            warn('[ Central ] Warning: ' .. Message)
        end
    end
    ...
    function Utility:EnableDragging(Frame, Parent)
        ...
        local Main = CoreGui:FindFirstChild('Central Command UI Library | .gg/DKsdCPt2Rj').Main
    ...
    function Utility:Destroy()
        ...
        for _, UI in next, CoreGui:GetChildren() do
            if UI.Name == 'Central Command UI Library | .gg/DKsdCPt2Rj' then
...
function Library:CreateWindow(Properties)
    -- // Properties
    local Name = Utility:GetProperty('Window', 'Name', Properties) or 'Central Command UI Library'
    local IntroText = Utility:GetProperty('Window', 'IntroText', Properties) or 'Central Command UI Library'
    ...
    local Container = Utility:Create('ScreenGui', {
        Parent = CoreGui,
        Name = 'Central Command UI Library | .gg/DKsdCPt2Rj',
        ResetOnSpawn = false
    }, {
    ...
    if IntroBlur == true then
        Utility:Create('BlurEffect', {
            Name = 'CentralIntroBlur',
            Parent = Lighting,
            Size = 0
        })

        local Blur = Lighting.CentralIntroBlur
    ...
    if IntroBlur == true then
        Utility:Tween(Lighting.CentralIntroBlur, {Size = 0}, 1)
    ...
    if IntroBlur == true then
        Lighting.CentralIntroBlur:Destroy()
    end
    ...
    local function Execute(String)
        ...
        local Command = assert(Commands[First], '[Central] Command Not Found: ' .. First)
