-- // Central Command UI Library Example
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/CentralDevelopment/CentralCMD/refs/heads/main/source.lua', true))()

local Window = Library:CreateWindow({
    Name = 'Central Command UI Library',
    IntroText = 'Central Command UI Library',
    IntroIcon = '',
    IntroBlur = true,
...
Window:AddCommand('Notify', {}, 'Creates A Notification.', function(Arguments, Speaker)
    Window:CreateNotification('Central Command UI Library', 'Notification', 5)
end)
